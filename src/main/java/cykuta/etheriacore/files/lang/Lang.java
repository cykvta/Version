...
public enum Lang {
    ...
    REGISTER_SUCCESS("register-success", LangType.SUCCESS),
    LOGIN_SUCCESS("login-success", LangType.SUCCESS),
    PASS_CHANGE("pass-change", LangType.SUCCESS),
    LOGIN("login", LangType.SUCCESS),
    REGISTER("register", LangType.SUCCESS),
    BAD_PASSWORD("bad-password", LangType.ERROR),
    ...
    PASSWORD_BAD_LENGTH("password-bad-length", LangType.ERROR),
    PASSWORD_BAD_CHARACTERS("password-bad-characters", LangType.ERROR),
    ...
    PASSWORD_NOT_MATCH("password-not-match", LangType.ERROR),
    REGISTER_ERROR("register-error", LangType.ERROR),
    ALREADY_REGISTERED("already-registered", LangType.ERROR),
    NOT_REGISTERED("not-registered", LangType.ERROR),
    COMMAND_ON_AUTH("command-on-auth", LangType.ERROR),
    ALREADY_LOGGED_IN("already-logged-in", LangType.ERROR),
    TIME_OUT("time-out", LangType.ERROR),
